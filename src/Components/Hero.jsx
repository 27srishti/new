      ...
      <motion.div
        ...
        <div className="text-white md:text-6xl  sm:text-5xl text-2xl font-bold font-Poppins md:py-6">
          ...
          >
            <div>
              We are One Stop
              <span className="pl-3 text-pink-600 font-Poppins ">
                Influencer
              </span>
              <br />
            </div>{" "}
          ...
          <motion.div
                ...
                >
          <a>
            <div className="pt-2 sm:pt-3 md:pt-7 font-Poppins  text-pink-600">
              Marketing Agency
            </div>
          </a>
          </motion.div>
        ...
        >
          ...
          <span class="absolute inset-0 border border-pink-500 rounded-full"></span>
        </a>
        </motion.div>
      </div>
    </div>
